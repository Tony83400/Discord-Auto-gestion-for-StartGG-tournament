...
translations = {
    "fr": {
        ...
        "match_started": "🎯 **Match commencé** - <@{p1_id}> vs <@{p2_id}> (BO{bo})",
    ...
    "en": {
        ...
        "match_started": "🎯 **Match started** - <@{p1_id}> vs <@{p2_id}> (BO{bo})",
        ...
        "launch_tournament_label": "🚀 Launch Tournament",
...
current_lang = os.getenv("LANG") or "en"  # Default to English if not set
